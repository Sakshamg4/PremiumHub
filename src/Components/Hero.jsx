  ...
  return (
    <div id="home" className="min-h-screen py-16 md:py-24">
      <div className="container mx-auto px-4">
        <div className="border-[1px] border-zinc-700 rounded-xl p-8 md:p-12 bg-gradient-to-b from-slate-900 to-slate-800">
          <div className="space-y-8 text-center max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight flex flex-col items-center gap-2">
                <span>Your One-Stop Destination for</span>
                <div className="h-[1.2em] w-full relative overflow-hidden">
                  <TypeAnimation
                    ...
                    speed={50}
                    repeat={Infinity}
                    className="text-teal-400 absolute left-1/2 -translate-x-1/2 min-w-max"
                    cursor={true}
                    deletionSpeed={50}
                  />
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-3xl mx-auto">
              {['Creative Tools', 'Business Apps', 'AI Solutions', 'Premium Support'].map((feature, index) => (
                <div key={index} className="border border-zinc-700 rounded-lg p-3 hover:border-blue-500 transition-all duration-300">
