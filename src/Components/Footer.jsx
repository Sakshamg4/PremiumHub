          ...
          <div className="space-y-6">
            <Link to="/" className="group inline-flex items-center gap-2">
              <span className="text-2xl font-bold bg-gradient-to-r from-white to-white/80 bg-clip-text text-transparent 
                transition-all duration-300 group-hover:from-blue-400 group-hover:to-blue-600">
                Premium
              </span>
        ...
        <div className="mt-16 pt-8 border-t border-zinc-800">
          <div className="text-center space-y-4">
            <p className="text-zinc-500">
              © {currentYear} Premium<span className="text-blue-500">Hub</span>. All rights reserved.
            </p>
            <p className="text-zinc-600 flex items-center justify-center gap-2 text-sm">
              Made with 
